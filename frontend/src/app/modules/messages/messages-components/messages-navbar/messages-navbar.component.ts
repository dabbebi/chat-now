...
import { ROUTES } from '../messages-sidebar/messages-sidebar.component';
...
export class MessagesNavbarComponent implements OnInit {
    ...
    getNb(){
      this.sharedService.getNb(localStorage.getItem('user_id')).subscribe((data : any) => {
        console.log(data);
        this.invi = data.invi;
